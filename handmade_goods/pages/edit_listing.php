        ...
        <div class="listing-form-container">
            <form action="edit_listing.php?id=<?= $product_id ?>" id="listingForm" method="POST"
                ...
                <div class="d-flex justify-content-center gap-3 mb-3">
                    ...
                    <button type="submit" id="submitButton" class="m-btn g">
                        <span class="material-symbols-outlined">save</span> Save Changes
                    </button>
                    <button type="button" class="m-btn r" onclick="showDeleteConfirmation()">
        ...
        <div class="modal-content" style="background-color: white; padding: 20px; border-radius: 5px; width: 80%; max-width: 500px; margin: auto;">
            ...
            <form method="POST" action="user_delete_listing.php">
                ...
                <div style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 20px;">
                    <button type="button" class="m-btn" onclick="closeDeleteModal()">Cancel</button>
                    <button type="submit" class="m-btn r">Delete</button>
                </div>
            </form>
        </div>
    </div>
