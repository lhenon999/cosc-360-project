        ...
        <div class="container mt-5">
            ...
            <div class="row mt-4">
                <?php foreach ($order_items as $item): ?>
                    <div class="col-md-6 mb-4">
                        <div class="order-item d-flex align-items-center">
                            <img src="<?= htmlspecialchars($item['img']) ?>" alt="<?= htmlspecialchars($item['name']) ?>" class="cart-img me-4">
                            <div class="item-desc">
                ...
                <div class="ending-div mt-5">
                    <a href="products.php" class="cta hover-raise"><span class="material-symbols-outlined">shoppingmode</span>Continue Shopping</a>
                </div>
        </div>
